...
function getDbPath() {
    ...
    try {
        ...
        if (process.platform === "win32") {
            userDataPath = path_1.default.join(process.env.APPDATA || home, "Atlas AI");
        }
        else if (process.platform === "darwin") {
            userDataPath = path_1.default.join(home, "Library", "Application Support", "Atlas AI");
        }
        else {
            userDataPath = path_1.default.join(home, ".config", "Atlas AI");
        }
    }
    fs_1.default.mkdirSync(userDataPath, { recursive: true });
    return path_1.default.join(userDataPath, "atlas.db");
}
